CardListActions = React.createClass({
    propTypes: {
    ...
    render() {
        return (
            <div className="buttons-group">
                ...
                {Auth.isAdmin() ? <button type="button" onClick={this.handleSynchronize} className="button mod-act mod-small"><i className="fa fa-refresh u-mr-5 u-va-middle"></i>Sync</button> : ''}
            </div>
        )
    }
});
